...
public class TicketMasterClient {
	...
	private static final int DEFAULT_RADIUS = 50;//默认搜半径
	private static final String API_KEY = "rILlGDjmPMThVdjPfptyArcAJxgIN6lI"; 
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		try {
			...
			//can use the getResponse(), connect(), getInputStream() or 
		...
		try {
			...
			//将event取出来
			//每个公司的API response的结构都不一样，java要根据不同结构进行处理
	...
	//implement some helper methods to fetch data fields which are included deeply
	//in TicketMaster response body
...
//				//2 is the indent Factor
//			 }
//			}catch(Exception  e) {
//				e.printStackTrace();
//			}
//	}//点run as Java application 
	//而不是 run as Server
	//因为server 是没有main 函数的
